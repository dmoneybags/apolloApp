...
struct AlertMeView: View {
    ...
    private let successBanner = NotificationBanner(title: "Success", subtitle: "Notification set", style: .success)
    ...
    var body: some View {
        TabView {
            ForEach(stats.indices, id: \.self){indice in
                ...
                .tabItem {
                    if stats.count > 1 {
                        Label(stats[indice].displayName, systemImage: "bolt.fill")
